...
LDFLAGS		+= -L src/libft/ -lft -L src/minilibx_macos_10.11/ -lmlx -framework OpenGL -framework AppKit

DLIBFT	:= src/libft
LIBFT	:= src/libft/libft.a
DLIBMLX	:= src/minilibx_macos_10.11
LIBMLX	:= src/minilibx_macos_10.11/libmlx.a
